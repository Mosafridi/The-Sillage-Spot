...
public class WelcomeServlet extends HttpServlet {
    ...
    out.println("<div class=\"footer-links\" style=\"text-align: center; margin-top: 20px;\">");
    out.println("<a href=\"index.html\" style=\"color: white; text-decoration: none;\">Home</a> | ");
    out.println("<a href=\"Perfume.html\" style=\"color: white; text-decoration: none;\">Perfumes</a> | ");
    out.println("<a href=\"About.html\" style=\"color: white; text-decoration: none;\">About</a> | ");
    out.println("<a href=\"contact.html\" style=\"color: white; text-decoration: none;\">Contact Us</a>");
    out.println("</div>");
